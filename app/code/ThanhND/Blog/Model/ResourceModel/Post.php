...
namespace ThanhND\Blog\Model\ResourceModel;
...
class Post extends AbstractDb
{
    ...
    public function __construct(DateTime $dateTime,Context $context, $connectionName = null)
    {
    ...
    {
        $this->_init('thanhnd_blog_post','post_id');
    }
    ...
    {
        $select = parent::_getLoadSelect($field, $value, $object); // TODO: Change the autogenerated stub
